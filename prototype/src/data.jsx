...
const STORAGE_KEY = 'budget_desk_v1';
const EXPORT_KEY = 'budget_desk_last_export';
...
function periodFor(refDate, settings) {
...
function endOfPeriod(start, settings) {
...
function shiftPeriod(period, dir, settings) {
...
function dayIndexInPeriod(dateISO, period) {
...
function setLastExport(iso) {
  localStorage.setItem(EXPORT_KEY, iso);
}

// expose
Object.assign(window, {
  STORAGE_KEY, EXPORT_KEY, ACCENT_PALETTES, DEFAULT_DASHBOARD_LAYOUT,
  loadState, saveState, getLastExport, setLastExport,
  periodFor, endOfPeriod, shiftPeriod, periodLabel, periodLengthDays, dayIndexInPeriod, inPeriod,
  fmtMoney, fmtMoneyCompact, fmtDate, fmtISO, parseISO,
  RU_MONTH, RU_MONTH_SHORT, pad,
});
