/* ============ app.jsx — root + state reducer + routing ============ */
    ...
    switch (route) {
      case 'dashboard':
        return <DashboardPage {...common}
          ...
          onDismissBanner={() => { const iso = new Date().toISOString().slice(0,10); setLastExport(iso); window.setLastExport(iso); }}
