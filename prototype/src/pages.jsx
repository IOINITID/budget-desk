...
function OperationModal({ state, dispatch, op, onClose, defaultType = 'expense' }) {
  const editing = !!op;
...
function DashboardPage({ state, dispatch, period, today, onOpenModal, onNav, lastExport, onExport, onNewCategory, onDismissBanner, showBanner }) {
...
function DashSlot({ widget, label, editing, children, onDragStart, onDragEnd, onDropOn, dragId, onHide, onSpanChange }) {
...
===================================================================== */
function OpTable({ state, ops, onEdit, compact }) {
...
function UpcomingIncome({ settings, today }) {
...
function QuickEntry({ state, dispatch }) {
...
/* =====================================================================
   OPERATIONS page
===================================================================== */
function OperationsPage({ state, dispatch, period, onOpenModal }) {
...
/* =====================================================================
   BUDGET (plan/fact)
===================================================================== */
function BudgetPage({ state, dispatch, period }) {
  const [editing, setEditing] = useState(null);
  const ops = state.operations.filter(o => inPeriod(o.date, period));
  const byCatExp = {};
