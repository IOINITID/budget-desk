...
/* ============ pages2.tsx — categories, accounts, goals, analytics, settings, export ============ */
import React, { useState, useEffect, useMemo } from 'react';
import { ACCENT_PALETTES, RU_MONTH_SHORT, dayIndexInPeriod, fmtDate, fmtISO, fmtMoneyCompact, inPeriod, parseISO, periodLengthDays, shiftPeriod } from './data';
import { CAT_COLORS, CatChip, ColorPicker, DailyBars, Donut, IconTile, Modal, PlanFactBars, StatCard } from './components';

/* =====================================================================
   CATEGORIES
===================================================================== */
export function CategoriesPage({ state, dispatch }) {
...
/* =====================================================================
   ACCOUNTS
===================================================================== */
export function AccountsPage({ state, dispatch }) {
...
export const TYPE_LABEL = { cash:'наличные', card:'карта', savings:'накопления', credit:'кредитка' };

/* =====================================================================
   GOALS / SAVINGS
===================================================================== */
export function GoalsPage({ state, dispatch }) {
  const [editing, setEditing] = useState(null);
...
/* =====================================================================
   ANALYTICS
===================================================================== */
export function AnalyticsPage({ state, period, today, settings }) {
...
export function ForecastChart({ actual, forecast, height = 140, labels }) {
  const w = 100;
...
/* =====================================================================
   SETTINGS
===================================================================== */
export function SettingsPage({ state, dispatch, lastExport, onExport, onImport, onReset, settings }) {
  return (
    <>
      <div className="grid grid-2">
        <div className="card">
...
export function RecurringIncomes({ settings, dispatch }) {
...
/* =====================================================================
   EXPORT / IMPORT page
===================================================================== */
export function ExportPage({ state, lastExport, onExport, onImport, onReset }) {
